                                        ...
                                        <div class="slider-active">
                                            ...
                                            @foreach($sliders as $slider)
                                                <div
                                                    ...
                                                    data-background="{{$slider->getFirstMediaUrl('image')}}">
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-xl-7 col-lg-7 col-md-9 col-sm-11 col-12">
                                                                <div class="slider__content slider__content-4">
                                                                    <h2 data-animation="fadeInUp"
                                                                        data-delay=".2s">{{$slider->title}}</h2>
                                                                    <p data-animation="fadeInUp"
                                                                       data-delay=".4s">{{$slider->description}}</p>
                                                                    @if($slider->link)
                                                                        <a href="{{$slider->link}}"
                                                                           class="os-btn os-btn-2"
                                                                           data-animation="fadeInUp" data-delay=".6s">Daha
                                                                            ətraflı</a>
                                                                    @endif
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                                <div class="banner__item mb-30 p-relative">
                                                    <div class="banner__thumb fix">
                                                        <a href="{{$banner->link}}" class="w-img"><img
                                                                src="{{$banner->getFirstMediaUrl('image')}}"
                                                                alt="banner"></a>
                                                    </div>
                                                    <div class="banner__content p-absolute transition-3">
                                                        <h5><a href="{{$banner->link}}">{{$banner->title}}</a></h5>
                                                        <a href="{{$banner->link}}"
                                                           class="link-btn">{{@trans('content.readMore')}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                        ...
                                        <div class="col-xl-12">
                                            <div class="product__load-btn text-center mt-25">
                                                <a href="{{route('products')}}"
                                                   class="os-btn os-btn-3">{{@trans('content.allProducts')}}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="blog__item mb-30">
                                                        <div class="blog__thumb fix">
                                                            <a href="{{route('blog',$blog->id)}}">
                                                                <div class="productImg"
                                                                     style="background-image: url({{$blog->getFirstMediaUrl('image')}})"></div>
                                                            </a>
                                                        </div>
                                                        <div class="blog__content">
                                                            ...
                                                            <a href="{{route('blog',$blog->id)}}"
                                                               class="os-btn">{{@trans('content.readMore')}}</a>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
